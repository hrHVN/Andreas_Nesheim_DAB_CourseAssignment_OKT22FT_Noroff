...
connection.connect((err) => {
    ...
    const tablesList = [
        ...
        (id INT AUTO_INCREMENT PRIMARY KEY,name VARCHAR(255) NOT NULL,birthday DATE,species INT,
        ...
        (id INT AUTO_INCREMENT PRIMARY KEY,fullName VARCHAR(255) NOT NULL,userName VARCHAR(255) NOT NULL,
        password INT,FOREIGN KEY (password) REFERENCES passwords(id)
        ,role INT,FOREIGN KEY (role) REFERENCES role(id))`,
        `CREATE TABLE IF NOT EXISTS adoptions 
        (id INT AUTO_INCREMENT,animal INT,user INT,PRIMARY KEY (id, animal),
